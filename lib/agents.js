...
// Delete a subagent across every source (flat file only). Returns the removed paths.
...
module.exports = { resolve, list, agentDir, writeAgent, deleteAgent, sources, modelOf, skillsOf, bodyOf };
